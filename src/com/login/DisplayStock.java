...
public class DisplayStock extends ActionSupport{
	  ...
	  itemList  =  new ArrayList<Item>();
	      ...
	      try {
	    	  ...
	    	  String URL = "jdbc:mysql://localhost/paddy";
				...
				ResultSet rs1 = st1.executeQuery("select * from item where quantity > 0");
				...
				while (rs1.next()) {
					...
					itemList.add(ve);
					for(Item sub:itemList){
						
						catList.add(sub.getCategory());
